        ...
        <div className="hostel-detail">
            ...
            <div className="hostel-detail-right">
                ...
                <div className="hostel-detail-items">
                    <p>Price starts at:</p>
                    <h1>GHS {props.startPrice} <p>Per bed/semester</p></h1>
                    <div className="info">
                        <span><i className="fa fa-user"></i>{props.gender}</span>
                        <span><i className="fa fa-home fa-sm"></i>{props.roomCount}</span>
                    </div>
                    <div className="hostel-detail-items-footer">
                        <h2>Quick enquiry</h2>
                        <a href={`tel:${props.telephone}`}><i className="fa fa-phone"></i> {props.telephone}</a>
                    </div>
                </div>
