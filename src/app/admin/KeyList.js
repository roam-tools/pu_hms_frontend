...
export const KeyList = () => {
  ...
  useEffect(() => {
    const getStudents = async () => {
      try {
        const response = await http.get("key/rooms-state", {
          retry: 100,
          retryDelay: 3000,
        });
        setLoading(false);
  ...
  const handleRoomStatusChange = async () => {
    const state =
      room.event.toString().toLowerCase() === "opened" ? "CLOSED" : "OPENED";
    try {
      setLoading2(true);
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ display: "flex", flexDirection: "row" }}>
                        ...
                        />{" "}
                        <span style={{ alignSelf: "center" }}>
                          {moment(room.time_of_event).format(
      ...
      >
        ...
        <div
          style={{
            width: "100%",
            background:
              room?.event?.toLowerCase() === "opened" ? "#FFD0D0" : "#3EFF74",
            borderRadius: 10,
            height: 70,
            textAlign: "center",
            display: "flex",
        ...
        >
          <div>{room?.event === "OPENED" ? "CLOSED" : "OPENED"}</div>
        </div>
        <ul style={{ listStyle: "none", padding: 0, marginTop: 10 }}>
          <li style={{ padding: "10px 0", fontWeight: "bold" }}>
            This key request is been made by:
          </li>
          <Radio.Group
